...
| Store preparation | Worksheets ready                                 | Privacy/data-safety, metadata, rating, export, review notes and test matrix linked below                                                | Owner/console entry, legal identity confirmation, screenshots and account-level testing |

## Implemented release work

- Controlled upgrade/alignment to current Expo SDK 57 packages and React Native 0.86.2; duplicate native modules eliminated with a hoisted Bun workspace install.
...
5. **Create store assets and complete account-level forms.** Signed-build iPhone/iPad/Android screenshots, Google feature graphic, privacy/data-safety, rating, export, availability and pricing declarations remain manual.
